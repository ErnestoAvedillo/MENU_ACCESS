function initializeTorsionTooltips() {
    if (window.__torsionTooltipsInitialized) {
        return;
    }
    ...
    window.__torsionTooltipsInitialized = true;
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initializeTorsionTooltips);
} else {
    initializeTorsionTooltips();
}
